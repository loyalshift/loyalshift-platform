// src/pages/AnacoNotFound.js
// 404 Not Found page specifically styled for ANACO Inversiones.
...
export default function AnacoNotFound() {
    return (
        ...
        <div className={`min-h-screen ${colors.background} flex items-center justify-center text-center px-4 py-16`}>
            ...
            >
                ...
                >
                    {/* Back to Anaco Home */}
                    <Link
                        to="/anaco" // Link to the main Anaco section start page
                    ...
                    {/* Contact Link */}
                    <Link
                        to="/anaco/contacto" // Link to the Anaco contact page
