// src/pages/ProposalAnacoCtaPage.js
// Specific CTA page for the ANACO proposal flow, route: /demo/anaco/cta
...
export default function ProposalAnacoCtaPage() {
    ...
    return (
        ...
        <div className={`min-h-screen ${colors.background} flex flex-col items-center justify-center p-6`}>

            {/* Decorative Background Elements (Optional, similar to previous) */}
            <div className="fixed inset-0 overflow-hidden pointer-events-none -z-10">
                <div className="absolute inset-0 opacity-[3%]"> {/* Grid */}
                  <svg className="absolute inset-0 w-full h-full" xmlns="http://www.w3.org/2000/svg">
                    <defs><pattern id="line-grid-cta" width="40" height="40" patternUnits="userSpaceOnUse"><path d="M 40 0 L 0 0 0 40" fill="none" stroke={colors.textSecondary} strokeOpacity="0.3" strokeWidth="0.5"/></pattern></defs>
            ...
            >
                ...
                <motion.div variants={fadeInUp} className="mb-6">
                    <div className={`inline-flex p-4 rounded-full bg-slate-800 border ${colors.border}`}>
                ...
                >
                    Avancemos Juntos: Implementando <span className={colors.textHighlight}>ANACO Conecta</span>
                </motion.h1>
                ...
                >
                    Hemos delineado la estrategia para transformar la experiencia de sus agentes. El siguiente paso es definir los detalles de implementación y el programa piloto.
                </motion.p>
                ...
                >
                    {/* Primary CTA */}
                    <Button
                        to="/contact-sales?client=anaco&topic=hub-implementation&plan=starter" // Consistent link
