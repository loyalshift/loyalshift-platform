// src/pages/ProposalFinancialDetailsPage.js
...
const content = {
  ...
  ctaButton1: "Visitar Financial Landing Page", // Modified CTA text
...
export default function ProposalFinancialDetailsPage() {
