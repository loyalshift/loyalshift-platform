...
// "Smart" calculator for FINANCIAL - Mortgage Pre-Approval Estimator.
...
export default function FinancialCalculatorPage() {
  ...
  const [dtiRatio, setDtiRatio] = useState(0.4); // Default DTI Ratio (40%) - Adjust based on FINANCIAL/SUGEF stds
