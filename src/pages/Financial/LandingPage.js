// src/pages/Financial/FinancialLandingPage.js
...
import FloatingItemsBackground from "../../components/Financial/FloatingItemsBackground"; // Use the floating items background
...
// --- Main Financial Landing Page Component ---
    ...
    <div className={`${colors.background} font-sans`}>
      ...
      <main className="relative z-10">
       ...
       >
        ...
        {/* Why Choose Financial Section */}
        <section className="py-16 md:py-24" id="porque-financial">
...
// PropTypes
FinancialLandingPage.propTypes = {};
Button.propTypes = {
  to: PropTypes.string,
