// src/pages/FinancialContactPage.js
...
export default function FinancialContactPage() {
  ...
  return (
    <div className={`${colors.background} ${colors.textDark} font-sans`}>
      ...
      {/* Optional: Add FinancialHeader here */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 md:gap-16">
          ...
          >
            ...
            <ContactInfoItem
              ...
              lines={["info@financialcr.net"]}
              links={["mailto:info@financialcr.net"]}
            />
            {/* --- Map Container --- */}
            <motion.div
              variants={fadeInUp}
            ...
            >
              <iframe
                title="Mapa de ubicación del establecimiento"
                width="100%"
      ...
      {/* Optional: Add FinancialFooter here */}
    </div>
  );
}
