// src/pages/Financial/MortgageServices.js
// Explains FINANCIAL's Fixed-Rate Mortgage options for personal and business needs.
...
// Theme Colors (FINANCIAL Green/White/Grey)
const colors = {
...
export default function MortgageServicesPage() {
  ...
  // Example Limits (Inspired by INVU text, adjust for FINANCIAL's actuals)
  const exampleLimits = {
