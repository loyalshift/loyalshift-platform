// src/components/Anaco/AnacoHeader.js
...
import anacoLogoUrl from "../../images/anaco.png"; // Adjust path if needed
...
const AnacoHeader = ({ forceDark = false }) => {
    ...
    >
      <nav className="container mx-auto px-4 sm:px-6 py-3 flex justify-between items-center">
        ...
        <Link
          ...
          aria-label="ANACO Inversiones Home"
        >
          <img src={anacoLogoUrl} alt="ANACO Logo" className="h-8 w-auto" />
          {/* "Anaco" part uses dynamic primary color */}
          <span
        ...
        <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
          {[
            ...
            { path: "/anaco/pre-approval-process", label: "Pre-Aprobación" },
            {
